...
{
    Task<List<ConsentimientoDto>> ObtenerConsentimientosAsync(string pacienteId, CancellationToken ct = default);
    ...
    Task<ConsentimientoDto?> GuardarConsentimientoAsync(string programa, int version, string pacienteId, bool aceptacion, CancellationToken ct = default);
}
